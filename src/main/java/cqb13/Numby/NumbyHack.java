...
public class NumbyHack extends MeteorAddon {
	...
	public void onInitialize() {
		...
		MeteorClient.EVENT_BUS.registerLambdaFactory("cqb13.Numbyhack.modules", (lookupInMethod, klass) -> (MethodHandles.Lookup) lookupInMethod.invoke(null, klass, MethodHandles.lookup()));
		MeteorClient.EVENT_BUS.registerLambdaFactory("cqb13.Numbyhack.utils", (lookupInMethod, klass) -> (MethodHandles.Lookup) lookupInMethod.invoke(null, klass, MethodHandles.lookup()));
