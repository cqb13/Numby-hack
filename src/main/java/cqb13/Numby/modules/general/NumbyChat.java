...
public class NumbyChat extends Module {
    ...
    // Customize
    public final Setting<Boolean> emotes = sgCustom.add(new BoolSetting.Builder()
            .name("emotes")
    ...
    public final Setting<Boolean> customPrefix = sgCustom.add(new BoolSetting.Builder()
            .name("custom-prefix")
    ...
    public final Setting<String> prefixText = sgCustom.add(new StringSetting.Builder()
    ...
    public final Setting<Boolean> customPrefixColor = sgCustom.add(new BoolSetting.Builder()
    ...
    public final Setting<SettingColor> prefixColor = sgCustom.add(new ColorSetting.Builder()
            .name("prefix-color")
    ...
    public final Setting<Boolean> chromaPrefix = sgCustom.add(new BoolSetting.Builder()
            .name("chroma-prefix")
            .description("Lets you set a custom prefix.")
            .defaultValue(false)
            .build()
    ...
    public final Setting<Double> chromaSpeed = sgCustom.add(new DoubleSetting.Builder()
            .name("chroma-speed")
            ...
            .sliderMax(5)
            .decimalPlaces(2)
            .visible(chromaPrefix :: get).build()
    );

    public final Setting<Boolean> themeBrackets = sgCustom.add(new BoolSetting.Builder()
    ...
    public final Setting<Boolean> customBrackets = sgCustom.add(new BoolSetting.Builder()
    ...
    public final Setting<String> leftBracket = sgCustom.add(new StringSetting.Builder()
            .name("left-bracket")
            .description("")
            .defaultValue("[")
    ...
    public final Setting<String> rightBracket = sgCustom.add(new StringSetting.Builder()
            .name("right-bracket")
            .description("")
            .defaultValue("]")
            .visible(customBrackets :: get)
    ...
    public NumbyChat() {
        super(NumbyHack.CATEGORY, "numby-chat", "Improves your chat experience in various ways.");
    ...
    public void onActivate() {
        ChatUtils.registerCustomPrefix("cqb13.NumbyHack.modules.general", this::getPrefix);
        ChatUtils.registerCustomPrefix("cqb13.NumbyHack.modules.commands", this::getPrefix);
        ChatUtils.registerCustomPrefix("cqb13.NumbyHack.modules.hud", this::getPrefix);
    }
    ...
    private void onMessageSend(SendMessageEvent event) {
        ...
        if (emotes.get()) message = CHMainUtils.apply(message);
