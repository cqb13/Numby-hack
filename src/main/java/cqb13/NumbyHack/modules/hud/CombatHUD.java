...
// taken from old meteor version

public class CombatHUD extends HudElement {
    public static final HudElementInfo<CombatHUD> INFO = new HudElementInfo<>(NumbyHack.HUD_GROUP, "combat-info", "Displays information about your combat target.", CombatHUD::new);
    ...
    public void render(HudRenderer renderer) {
        renderer.post(() -> {
            ...
            Renderer2D.COLOR.quad(x, y, this.getWidth(), this.getHeight(), backgroundColor.get());
            ...
            Color nameColor = PlayerUtils.getPlayerColor(playerEntity, TextHud.getSectionColor(0));
            ...
            Color friendColor = TextHud.getSectionColor(0);
            ...
            TextRenderer.get().render(nameText, x, y, nameColor != null ? nameColor : TextHud.getSectionColor(0), true);
            ...
            if (displayPing.get()) {
                TextRenderer.get().render(breakText, x + friendWidth, y, TextHud.getSectionColor(1), true);
                TextRenderer.get().render(pingText, x + friendWidth + breakWidth, y, pingColor);

                if (displayDistance.get()) {
                    TextRenderer.get().render(breakText, x + friendWidth + breakWidth + pingWidth, y, TextHud.getSectionColor(1), true);
