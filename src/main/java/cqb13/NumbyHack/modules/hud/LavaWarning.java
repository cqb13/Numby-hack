...
public class LavaWarning extends HudElement {
    public static final HudElementInfo<LavaWarning> INFO = new HudElementInfo<>(NumbyHack.HUD_GROUP, "lava-warning", "Warns you when there is lava under you.", LavaWarning::new);
